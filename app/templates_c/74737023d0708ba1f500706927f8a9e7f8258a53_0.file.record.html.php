<?php
/* Smarty version 3.1.33, created on 2019-05-22 17:42:12
  from 'C:\dev\domain\app\view\record\record.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ce51974ac8471_64751885',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '74737023d0708ba1f500706927f8a9e7f8258a53' => 
    array (
      0 => 'C:\\dev\\domain\\app\\view\\record\\record.html',
      1 => 1558517987,
      2 => 'file',
    ),
  ),
...
function content_5ce51974ac8471_64751885 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <table border="1" align="center" id="record-table">
        <tr>
            <td colspan="11" id="d_id">
                <?php if (isset($_smarty_tpl->tpl_vars['domain']->value)) {
echo $_smarty_tpl->tpl_vars['domain']->value['d_name'];
}?>
            </td>
        </tr>
        <tr>
        ...
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['record']->value, 'value');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['value']->value) {
?>
        <tr data-record-id="<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
">
            <td><input type="checkbox" class="r_id" name="check_rid"></td>
            <td class="r_name"><?php echo $_smarty_tpl->tpl_vars['value']->value['r_name'];?>
</td>
            <td><select class="r_account">
                    <option class="r_ip"><?php echo $_smarty_tpl->tpl_vars['value']->value['r_ip'];?>
</option>
                </select></td>
            <td><?php if ($_smarty_tpl->tpl_vars['value']->value['status'] == 1) {?>已启用<?php } else { ?>已禁用<?php }?></td>
            <td class="r_remark"><?php echo $_smarty_tpl->tpl_vars['value']->value['remark'];?>
</td>
            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['r_time'];?>
</td>
            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['option_time'];?>
</td>
            <td><input type="button" value="解析" class="record-inside"></td>
            <td><input type="button" value="管理" class="record-manage" record-id="<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
"</td>
            <td><input type="button" value="<?php if ($_smarty_tpl->tpl_vars['value']->value['status'] == 1) {?>禁用<?php } else { ?>启用<?php }?>" class="record-status1"
                       data-record-status="<?php echo $_smarty_tpl->tpl_vars['value']->value['status'];?>
"></td>
        </tr>
        <?php
}
        ...
        <tr>
            <td colspan="10">
                ...
                <b style="float: right">&nbsp;<input type="text" id="record-page" style="max-width: 15px"
                                                     placeholder="<?php if ($_smarty_tpl->tpl_vars['count']->value == 0) {?>1<?php } else {
echo $_smarty_tpl->tpl_vars['page_val']->value;
}?>">


                    |<b id="count">
                        <?php if ($_smarty_tpl->tpl_vars['count']->value == 0) {?>1<?php } else {
                    ...
                    <table style="position: relative;right: 100px">
                        ...
                        <tr class="add-line">
                            ...
                            <td><select class="add-r_ip">
                                    <option></option>
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_server']->value, 'value');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['value']->value) {
?><option><?php echo $_smarty_tpl->tpl_vars['value']->value['server_ip'];?>
</option><?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
>
        ...
        $(".add-line").each(function () {
            if ($(this).find(".add-record_name").val() != "") {
                var record = {
                    ...
                    "d_id":<?php echo $_smarty_tpl->tpl_vars['domain']->value['id'];?>
    ...
    function flash_table(record, pageSize, page_val, all_count, count) {
        ...
        var table = "<tr>" +
            "<td colspan='10' id='d_id'><?php echo $_smarty_tpl->tpl_vars['domain']->value['d_name'];?>
</td>" +
            "</tr>" +
            "<tr>" +
            "<td></td>" +
    ...
    //    尾页
    $("body").delegate("#record-last-page", "click", function () {
        var account_name = <?php echo $_smarty_tpl->tpl_vars['all_account']->value;?>
;
        var page_val = $("#count").text();
        var id = <?php echo $_smarty_tpl->tpl_vars['domain']->value['id'];?>
;
        $.ajax({
...
;
    ...
    $("body").delegate(".r_id", "click", function () {
        if ($(this).prop("checked") === true) {
            $(this).closest("tr").find(".r_account").append("<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_server']->value, 'value');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['value']->value) {
?><option><?php echo $_smarty_tpl->tpl_vars['value']->value['server_ip'];?>
